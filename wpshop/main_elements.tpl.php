...
<div class="login_container">
	<ul class="user_infos">
		<li><strong> <a href="{WPSHOP_LOGIN_URL}"><i class="fa fa-user"></i> {WPSHOP_ACCOUNT_LOGIN}</a></strong>
				<a class="user_infos_more" href="{WPSHOP_LOGOUT_URL}"></a>
		</li>
	</ul>
</div>
<?php
...
<div class="login_container">
	<ul class="user_infos">
		<li>
			<i class="fa fa-user"></i> <a class="user_infos_more" href="{WPSHOP_LOGIN_URL}">Se connecter</a>
		</li>
	</ul>
</div>
<?php
